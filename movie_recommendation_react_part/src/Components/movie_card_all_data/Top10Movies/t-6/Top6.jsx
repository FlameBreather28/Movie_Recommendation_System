        ...
        <div className="detailed-movie-info">
            ...
            <div className="detailed-movie-info-all">
                ...
                <div className="detailed-move-info-all-data"><p>
                    <h3>Plot :  </h3> Harry, Ron, and Hermione search for Voldemort's remaining Horcruxes in their effort to destroy the Dark Lord as the final battle rages on at Hogwarts.</p></div>
